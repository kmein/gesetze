...
- 1. :: ein Gehalt an Gesamtnährstoffen in der Trockenmasse von mehr als
  ...
  - b) :: 0,5 vom Hundert Phosphat (P_{2}O_{5}),
  - c) :: 0,75 vom Hundert Kaliumoxid (K_{2}O),
...
- 2. :: auf das Produkt bezogene Anwendungsempfehlungen bei einer einmaligen Anwendung zu einer Aufbringung von mehr als 50 Kilogramm N, 30 Kilogramm P_{2}O_{5}, 50 Kilogramm K_{2}O, 500 Kilogramm CaO oder 15 Kilogramm S je Hektar führen würden.
...
- 3. :: Nährstoffe in Worten und in chemischen Symbolen wie folgt angegeben sind:
  - a) :: es müssen die nachstehenden chemischen Symbole und Formeln verwendet werden:
    ...
    | Calcium           | Ca         |
    | Calciumoxid       | CaO        |
    | Calciumcarbonat   | CaCO_{3}   |
    | Magnesium         | Mg         |
    | Magnesiumoxid     | MgO        |
    | Magnesiumcarbonat | MgCO_{3}   |
    | Natrium           | Na         |
    | Schwefel          | S          |
    | Bor               | B          |
    | Eisen             | Fe         |
  ...
  - b) :: zur der nach Buchstabe a vorgeschriebenen Oxid- und Carbonatform der Pflanzennährstoffe Phosphor, Kalium, Calcium und Magnesium kann zusätzlich auch deren Elementform angegeben sein, dazu müssen die Gehalte wie folgt umgerechnet sein:
    |            |         |                |
    | P_{2}O_{5} | x 0,436 | = P (Phosphor) |
    | K_{2}O     | x 0,83  | = K (Kalium)   |
    | CaO        | x 0,715 | = Ca           |
    | CaCO_{3}   | x 0,4   | = Ca           |
    | CaCO_{3}   | x 0,56  | = CaO          |
    | MgCO_{3}   | x 0,478 | = MgO          |
...
- 3. :: Nummer 1 gilt nicht für einen anzugebenden Anteil an wasserlöslichem P_{2}O_{5}, soweit bei einzelnen Düngemitteltypen abweichende Regelungen getroffen sind.
...
- 4 :: Für Kalkdünger gelten die Mindestgehalte nach Spalte 2 und, vorbehaltlich der besonderen Bestimmungen in Spalte 6, die angegebenen Gehalte an CaO oder CaCO_{3} auch dann als erreicht, wenn das Düngemittel anstelle eines Teiles CaO einen Teil MgO und anstelle eines Teiles CaCO_{3} einen Teil MgCO_{3} enthält.
...
Kalk bewertet als CaCO_{3};\\
Siebdurchgang:\\
97 % bei 3,15 mm\\
70 % bei 1,0 mm\\
Reaktivität, bewertet nach\\
Umsetzung in verdünnter\\
Salzsäure, mindestens 30 %, ab einem Gehalt von 25 % MgCO_{3} mindestens 10 %\\
Toleranzen:\\
 CaCO_{3} 4 %-Punkte,\\
 MgCO_{3} 2,5 %-Punkte nach unten und\\
 5 %-Punkte nach oben,\\
 insgesamt (CaCO_{3} + MgCO_{3}) 4 %-Punkte
...
Gehalt an MgCO_{3} und MgO mehr als 15 % beträgt.\\
...
- -- :: Mindestgehalt nach Spalte 2: 65 % CaCO_{3},
...
- -- :: Mindestgehalt nach Spalte 2: 60 % CaCO_{3},
- -- :: keine Mischung mit anderen kohlensauren\\
  Kalken,
- -- :: das Düngemittel muss als �Kohlensaurer\\
...
- -- :: Mindestgehalt nach Spalte 2: 70 % CaCO_{3},
...
- --  :: Mindestgehalte nach Spalte 2: 30 % CaO, 3 % P_{2}O_{5}
...
Toleranzen:\\
MgCO_{3} 2 %-Punkte\\
Angabe der basisch wirksamen Bestandteile in % CaCO_{3}\\
...
- -- :: Weitere Erfordernisse nach Spalte 4:\\
  ...
  K_{2}O, Höchstgehalt an Chlorid\\
...
- -- :: Spalte 4: Kalk bewertet als CaCO_{3};
...
Bei Einschlie�verkapselt“ zu bezeichnen.\\
...
- 3. :: Bei Kalken darf ab einem Gehalt an MgCO_{3} von\\
  15 % oder MgO von 7 % die Typenbezeichnung\\
  um das vorgestellte Wort �Magnesium“ ergänzt sein. Abweichend von Satz 1 darf das Düngemittel als �Kohlensaurer Magnesiumkalk“ bezeichnet sein, wenn der Gehalt an MgCO_{3} und MgO mehr als 15 % beträgt.
...
- 2. :: Zusätzlich sind anzugeben:
  - -- :: Nährstoffgehalte für N, P_{2}O_{5} und K_{2}O,
...
- 2. :: Nährstoffgehalte für N, P_{2}O_{5} und K_{2}O nach\\
...
- 2. :: pH-Wert (CaCl_{2}) nach Tabelle 1 Nummer 1.3.7\\
...
- 3. :: Bei Kultursubstraten: Angabe der Nährstoffe in mg/l bezogen auf das Nettovolumen, dabei für N, P_{2}O_{5}, K_{2}O und Mg als pflanzenverfügbare (lösliche) Nährstoffe unter Angabe der Methode.
