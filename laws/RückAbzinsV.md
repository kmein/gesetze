...
<tr class="odd">
<td style="text-align: left;" data-valign="top" data-charoff="50">S <sub>t</sub> =</td>
<td data-valign="top" data-charoff="50">Festzins-Swapsatz mit Laufzeit
t in Jahren,</td>
</tr>
<tr class="even">
<td style="text-align: left;" data-valign="top" data-charoff="50">N <sub>t</sub> =</td>
<td data-valign="top" data-charoff="50">Null-Kupon-Swapsatz mit Laufzeit
t und Zinszahlung erst am Laufzeitende,</td>
</tr>
<tr class="odd">
<td style="text-align: left;" data-valign="top" data-charoff="50">T<sub>t 1,t 2</sub> =</td>
<td data-valign="top" data-charoff="50">impliziter Null-Kupon-Termin-Swapsatz mit Laufzeit von
t 1 bis
t 2.</td>
</tr>
</tbody>
...
N<sub>1</sub>. Die weiteren ganzjährigen Null-Kupon-Swapsätze werden wie folgt schrittweise berechnet:  
...
t 3 stellt sich wie folgt dar, wobei S<sub>1</sub>, S<sub>2</sub>,…, S<sub>t 1</sub> und S<sub>t 3</sub> sowie N<sub>1</sub>, N<sub>2</sub>,…, N<sub>t 1</sub> bekannt sind,
...
T<sub>t 1,t 3</sub>) wird in der letzten Gleichung, da der Swapsatz mit Laufzeit

t 3 (

S<sub>t 3</sub>) und die Null-Kupon-Swapsätze

N<sub>1</sub> bis

N<sub>t 1</sub> bekannt sind, mittels eines numerischen Verfahrens (Newton-Verfahren) berechnet. Danach wird der Null-Kupon-Swapsatz mit Laufzeit

t 2 (

N<sub>t 2</sub>) durch das Einsetzen des Termin-Swapsatzes

T<sub>t 1,t 3</sub> in die folgende Gleichung bestimmt:  
...
U<sub>z</sub> die Rendite des Unternehmensanleihenindexes,

tz die durchschnittliche Laufzeit der Anleihen des Indexes und

N<sub>tz</sub> der Null-Kupon-Swapsatz mit Laufzeit

t zum Zeitpunkt

z.Der Aufschlag (

A<sub>z</sub>) ergibt sich wie folgt:  
...
AS<sub>tz</sub>) ergibt sich dann als Summe vom jeweiligen gemittelten Null-Kupon-Swapsatz und dem für diesen Zeitpunkt einheitlichen Aufschlag:  
