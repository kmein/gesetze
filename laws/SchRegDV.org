...
- 7. :: Eigentümer (owner):\\
  \\
  | Laufende\\ | Eigentümer, Korrespondentreeder\\ | Schiffs-\\   | Erwerbsgrund\\                |
  | Nummer\\   | (name of owner, managing owner)   | parten\\     | (legal ground of acquisition) |
  | (serial\\  |                                   | (shares in\\ |                               |
  | number)    |                                   | the ship)    |                               |
  |------------+-----------------------------------+--------------+-------------------------------|
  |            |                                   |              |                               |
...
\\
| Laufende\\      | Betrag\\ | Inhalt der Eintragung\\                  |
| Nummer\\        | (amount) | (text of entry in the shipping register) |
| (serial number) |          |                                          |
|-----------------+----------+------------------------------------------|
|                 |          |                                          |
|                 |          |                                          |
...
\\
| Zu\\              | Beschränkungen\\               |
| lfd. Nr.\\        | (alterations of entries above) |
| (related serial\\ |                                |
| number above)     |                                |
|                   |                                |
|                   |                                |
...
- 6. :: Eigentümer:\\
  \\
  | Laufende\\ | Eigentümer | Anteile | Erwerbsgrund |
  | Nummer     |            |         |              |
  |------------+------------+---------+--------------|
  |            |            |         |              |
  |            |            |         |              |
